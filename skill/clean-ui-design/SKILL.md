...
## Tool catalog (12 tools — three tiers)
...
capture (motion, interaction polish, component craft). Apply at synthesis time.

- `references/banned-phrases.md` — the full banned-phrase list (enforced).
